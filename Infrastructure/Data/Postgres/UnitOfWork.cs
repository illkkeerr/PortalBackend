...
public class UnitOfWork : IUnitOfWork
{
	...
	private AccountHistoryRepository? _accountHistoryRepository;
	...
	public IMessageRepository Messages => _messageRepository ??= new MessageRepository(_postgresContext);

	public IAccountHistoryRepository AccountHistories => _accountHistoryRepository ??= new AccountHistoryRepository(_postgresContext);
